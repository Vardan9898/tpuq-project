<x-layout>
    <div class="mt-5 col-6 m-auto d-flex justify-content-center">
        <h1>Here you can register in our web site or <a class="btn btn-primary"
                                                        href="{{ action([\App\Http\Controllers\SessionsController::class, 'create']) }}">Login</a>
        </h1>
    </div>
    <form action="{{ action([\App\Http\Controllers\RegisterController::class, 'store']) }}" method="POST"
          class="col-4 m-auto mt-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
